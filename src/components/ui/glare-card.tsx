...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate h-full w-full [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform"
      ref={refElement}
      onPointerMove={(event) => {
